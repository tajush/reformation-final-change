const selectShopMenuItem = document.getElementsByClassName('menu-item-has-children menu-item-has-megamenu')[0];
const MenuShopItemAttr = selectShopMenuItem.getAttribute('data-item-title','SHOP');
if(MenuShopItemAttr === "SHOP"){
  const shopMegaFirstEle = selectShopMenuItem.childNodes[2].childNodes[0].childNodes[0].childNodes[1];
  const shopMegaSecondEle = selectShopMenuItem.childNodes[2].childNodes[0].childNodes[0].childNodes[2].childNodes[0].childNodes[1];
  const shopMegaThirdEle = selectShopMenuItem.childNodes[2].childNodes[0].childNodes[0].childNodes[2].childNodes[1].childNodes[1];

  shopMegaFirstEle.style.fontWeight="bold";
  shopMegaSecondEle.style.fontWeight="bold";
  shopMegaThirdEle.style.fontWeight="bold";
...
//     // Uncomment and customize this part if needed
//     /*
...
// });
 ...
 //    document.querySelector('.popup-form').classList.add('hidden'); // Hide the form
 //    document.getElementById('thank-you-message').classList.remove('hidden'); // Show the thank you message
 //  });

   document.addEventListener("DOMContentLoaded", function() {
    // Select the element by its ID
    const element = document.getElementById('Accordion-collapsible_tab_izLVER-sections--22789074551075__footer');
    
    // Check if the element exists and has a first child
    if (element && element.firstElementChild) {
        // Add a click event listener to the first child
        element.firstElementChild.addEventListener('click', function() {
            // Your click function code here
            // alert('First child clicked!');
           const showBannerButton = document.getElementById('Accordion-collapsible_tab_izLVER-sections--22789074551075__footer');
        ...
        console.error('Element or its first child not found');
    }
});
...
// Function to set button colors based on localStorage
function setButtonColors() {
    if (localStorage.getItem('button1Red') === 'true') {
        document.getElementById('button1').classList.add('red');
    } else {
        document.getElementById('button1').classList.remove('red');
    }

    if (localStorage.getItem('button2Red') === 'true') {
        document.getElementById('button2').classList.add('red');
    } else {
        document.getElementById('button2').classList.remove('red');
    }
}
...
document.getElementById('button1').addEventListener('click', function() {
    document.getElementById('button2').classList.add('red');
    document.getElementById('button1').classList.remove('red');
    localStorage.setItem('button2Red', 'true');
    localStorage.setItem('button1Red', 'false');
});

document.getElementById('button2').addEventListener('click', function() {
    document.getElementById('button1').classList.add('red');
    document.getElementById('button2').classList.remove('red');
    localStorage.setItem('button1Red', 'true');
    localStorage.setItem('button2Red', 'false');
});
